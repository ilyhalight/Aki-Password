...
"    border-radius:  20px\n"
"}")
        self.frame_remove.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_remove.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_remove.setObjectName("frame_remove")
        self.l_remove_row = QtWidgets.QLabel(self.frame_remove)
        self.l_remove_row.setGeometry(QtCore.QRect(0, 10, 741, 41))
        font = QtGui.QFont()
        font.setFamily("Acrom")
        font.setPointSize(30)
        self.l_remove_row.setFont(font)
        self.l_remove_row.setAlignment(QtCore.Qt.AlignCenter)
        self.l_remove_row.setObjectName("l_remove_row")
        self.remove_row = QtWidgets.QLineEdit(self.frame_remove)
        self.remove_row.setGeometry(QtCore.QRect(230, 180, 261, 41))
        font = QtGui.QFont()
        font.setFamily("Acrom")
        self.remove_row.setFont(font)
        self.remove_row.setStyleSheet("QLineEdit {\n"
"    border: none;\n"
"    background-color: #0e0e0e;\n"
"    border-radius: 7px;\n"
"    color: #fff\n"
"}")
        self.remove_row.setInputMask("")
        self.remove_row.setObjectName("remove_row")
        self.l_number_row = QtWidgets.QLabel(self.frame_remove)
        self.l_number_row.setGeometry(QtCore.QRect(230, 160, 251, 16))
        font = QtGui.QFont()
        font.setFamily("Acrom")
        font.setPointSize(12)
        self.l_number_row.setFont(font)
        self.l_number_row.setObjectName("l_number_row")
        self.remove_complete = QtWidgets.QPushButton(self.frame_remove)
        self.remove_complete.setGeometry(QtCore.QRect(230, 360, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Acrom")
        self.remove_complete.setFont(font)
        self.remove_complete.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.remove_complete.setStyleSheet("QPushButton {\n"
"    color: #fff;\n"
"    border: none;\n"
"    border-radius: 10.5px;\n"
"    background-color: rgb(230, 52, 98)\n"
"}")
        self.remove_complete.setObjectName("remove_complete")
        self.remove_cancel = QtWidgets.QPushButton(self.frame_remove)
        self.remove_cancel.setGeometry(QtCore.QRect(380, 360, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Acrom")
        self.remove_cancel.setFont(font)
        self.remove_cancel.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.remove_cancel.setStyleSheet("QPushButton {\n"
"    color: #fff;\n"
"    border: none;\n"
"    border-radius: 10.5px;\n"
